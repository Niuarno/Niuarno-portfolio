...
// Helper functions for remember device functionality
...
function getRememberedToken(): string | null {
  try {
    ...
    const data: RememberedToken = JSON.parse(stored);
    ...
    <div className="space-y-8">
      ...
      <div className="p-6 rounded-2xl bg-card border border-border">
        ...
        <div className="flex flex-wrap gap-3">
          <a href="/niuarno-admin#/projects" className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 text-primary rounded-lg hover:bg-primary/20 transition-colors">
            <Plus className="w-4 h-4" /> Add Project
          </a>
          <a href="/niuarno-admin#/messages" className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 text-primary rounded-lg hover:bg-primary/20 transition-colors">
            <Mail className="w-4 h-4" /> View Messages
          </a>
          <a href="/niuarno-admin#/settings" className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 text-primary rounded-lg hover:bg-primary/20 transition-colors">
...
// Circular Image Upload Component for Profile Picture
                ...
                <div key={field.key} className="space-y-2">
                  {field.type === "image" ? (
                    <CircularImageUpload
                      ...
                      onChange={(base64) => setSettings({ ...settings, [field.key]: base64 })}
                    />
                  ) : field.type === "textarea" ? (
                    <>
...
export default function NiuarnoAdminPage() {
  ...
  useEffect(() => {
    // Using setTimeout to defer state updates to avoid cascading renders
